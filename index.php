          ...
          -->
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-6 ">
                        <div class="social-icon">
                            <span>Follow Us</span>
                            <a id="facebook" href="https://www.facebook.com/metastackoptions/">
                                <svg viewBox="0 0 169.17 169.17">
                                    <use xlink:href="#facebook"></use>
                                </svg>
                            </a>
                            <a id="twitter" href="https://twitter.com/metastackoptions">
                            ...
                            <a id="instagram" href="https://www.instagram.com/metastackoptions/">
                ...
                <div class="copyright"> <span style="color: #dae7ed;font-size: 10px;">249 GROSVENOR STREET, MAYFAIR, LONDON, ENGLAND, W1K 3HP
                        <br>
                        <a target="_blank" href="https://find-and-update.company-information.service.gov.uk/company/08939022">Meta Stack, 08939022</a> </span> <br>
                    <p>© 2017 Meta Stack Options Limited. All Rights Reserved. </p>
                </div>
            </div>
        </div>
...
//            console.log(current_diff1);
        ...
        <div class="modal-general deposit_modal1" bis_skin_checked="1" style="display: none;">
            ...
            <form method="post" id="deposit_form1">
              ...
              <h4 style="text-align:center;">to Meta Stack</h4>
                ...
                <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin: 40px auto !important;text-align: center;display: flex;justify-content: center; ">
		<button class="btn btn--blue register-btn" style="text-decoration:none" id="de_submit"> <span>Pay to Meta Stack</span>
				<div class="spinner" style="display:block">
					<div class="bounce1"></div>
					<div class="bounce2"></div>
					<div class="bounce3"></div>
...
//                            $("#pay_now_button").attr("href", json.gateway_url);
                    ...
                    console.log(json.error);
                        $("#de_submit").html('Pay to Meta Stack');
                    },
                    error: function(response) {
                        console.log(response);
                        $("#de_submit").html('Pay to Meta Stack');
            ...
            <form method="post" id="deposit_form2">
              ...
              <h2 style="text-align:center;">Pay With <span class="paynow_currency"></span> to Meta Stack</h2><br>
...
//                console.log("Hash Button CLicked");
    ...
    <script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="60ec42d6-cc2a-46a9-b79e-92dc6c3248ea";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
